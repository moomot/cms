   ...
   <div class="col-md-3">
       <div class="well well-sm">
           ...
           $nav->setModel(
               [
                   "url" => '/admin',
                   "content" => "<span class=\"glyphicon glyphicon-home\"></span> Dashboard"
               ],
               [
                   "url" => "/admin/tabs",
                   "content" => "<span class=\"glyphicon glyphicon-list\"></span> Экраны"
               ],
               [
                   "url" => "/admin/settings",
                   "content" => "<span class=\"glyphicon glyphicon-wrench\"></span> Настройки"
               ]
